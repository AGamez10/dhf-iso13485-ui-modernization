...
<html>
    <head>
        ...
        <%-- FIX pantalla negra (login colgado): se elimino el <link> CDN externo render-blocking
             (cdn.jsdelivr.net bootstrap). Es redundante con el bootstrap LOCAL de la linea de arriba
             y viola la regla de "cero CDNs". Un recurso externo bloqueante cuelga el render del login
             cuando el navegador no lo resuelve (SRI/CORS/proxy/tracking-protection). --%>
    ...
    <body>
        ...
        <%-- FIX pantalla negra (login colgado): se reemplazaron los <script> CDN externos
             render-blocking (code.jquery.com jQuery-slim, jsdelivr popper, jsdelivr bootstrap) por
             sus equivalentes LOCALES. jQuery (full) ya lo carga Contenedor_head.jsp; bootstrap.min.js
             ya esta local arriba; popper se sirve local. Elimina el cuelgue del login por recursos
             externos no resueltos por el navegador (regla: cero CDNs). --%>
        <script src="Interfaz/Contenido/assets/js/popper.min.js"></script>
