                                        ...
                                        function opShowActivityDetail(index, activityElements, detailPanel, masterPanel) {
                                            ...
                                            if (blocks.length > 0) {
                                                blocks.forEach(function (blockRows, subIndex) {
                                                    ...
                                                    cardsHtml += '<div class="op-activity-item-card mb-4 p-4 border rounded" style="border-radius:12px; background:#ffffff; box-shadow:0 4px 15px rgba(0,0,0,0.04); border:1px solid #cbd5e1;" data-id-memoria="' + idMemoria + '">'
                                                        ...
                                                        + (isEditable ? ('    <div class="op-doc-toolbar d-flex align-items-center flex-wrap mt-2" style="gap:6px;">'
                                                            ...
                                                            + '      <button type="button" class="btn btn-sm btn-outline-info font-weight-bold" onclick="opOpenFileManagerForActivity(' + index + ', ' + subIndex + ')" style="font-size:11px;" title="Seleccionar y vincular un archivo existente a esta actividad"><i class="fas fa-link mr-1"></i> Vincular archivo</button>'
                                                            + '      <button type="button" class="btn btn-sm btn-outline-secondary font-weight-bold" onclick="opOpenFileManagerModal()" style="font-size:11px;" title="Abrir el Gestor de Archivos completo (Office Platform)"><i class="fas fa-folder-open mr-1"></i> Gestor de Archivos</button>'
                                                ...
                                                cardsHtml = '<div class="op-activity-item-card mb-4 p-4 border rounded" style="border-radius:12px; background:#ffffff; box-shadow:0 4px 15px rgba(0,0,0,0.04); border:1px solid #cbd5e1;">'
                                                    ...
                                                    + '        <button type="button" class="btn btn-sm btn-outline-info font-weight-bold" onclick="opOpenFileManagerForActivity(' + index + ', 0)" style="font-size:11px;" title="Seleccionar y vincular un archivo existente a esta actividad"><i class="fas fa-link mr-1"></i> Vincular archivo</button>'
                                                    + '        <button type="button" class="btn btn-sm btn-outline-secondary font-weight-bold" onclick="opOpenFileManagerModal()" style="font-size:11px;" title="Abrir el Gestor de Archivos completo (Office Platform)"><i class="fas fa-folder-open mr-1"></i> Gestor de Archivos</button>'
